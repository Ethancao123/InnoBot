...
def mpu6050_conv():
    ...
    a_x =  (0.99805022 * a_x) +  0.06482607
    a_y =  (0.99708505 * a_y) + 0.11890353
    a_z =  (0.97933545 * a_z) - 0.07126188

    w_x = w_x - 6.61671447754
    w_y = w_y - 13.9932556152
    w_z = w_z + 0.809265136719
    #convert to acceleration in m/s^2 and gyro in rad/s
    a_x = a_x * 9.80665
    a_y = a_y * 9.80665
    a_z = a_z * 9.80665
